...
public class Controller {
    ...
    public void runApp(){
        try {
            ...
            System.out.println("Added railway stations to the map.");
            ...
            System.out.println("Loaded train names from file.");
            ...
            System.out.println("Generated and initialized locomotives.");
            ...
            logger.start();
            System.out.println("Logger thread started to track application state.");
    ...
    private void printInstructions() {
        ...
        System.out.println("1. add train <train_name>");
        System.out.println("2. add connection <station1> <station2> <distance>");
        System.out.println("3. add station <station_name>");
        System.out.println("4. add railcar <train_id> <railcar_type>");
        System.out.println("5. remove train <train_id>");
        System.out.println("6. remove connection <station1> <station2>");
        System.out.println("7. remove station <station_name>");
        System.out.println("8. remove railCar <train_id> <railcar_id>");
        System.out.println("9. getInfo <train_id>");
        System.out.println("10. Type 'quit' to exit the application.");
        System.out.println("11. Type 'help' to display this menu again.\n");
    }
}
